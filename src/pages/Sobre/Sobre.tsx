    ...
    <Styled.Container>
      ...
      <Styled.Content id="SobreMim">
        ...
        <p>
          ...
          usuário. Através da união entre tecnologia e design, levo um olhar
          ...
          uma experiência agradável. Meu portifólio é diversificado e cada um
          dos Projetos reflete minha paixão, dedicação e compromisso com a
